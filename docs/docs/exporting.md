...
Kova can export your presentation to **PDF** or **PowerPoint (`.pptx`)** — both are generated entirely in-process with no internet connection required.
...
2. Choose a format: **PDF** or **PowerPoint (.pptx)**.
