...
const RELEASE_TAG  = 'v0.1.0-alpha.1';
const RELEASE_BASE = `https://github.com/KovaMD/Kova/releases/download/${RELEASE_TAG}`;

const DOWNLOAD = {
  mac:   { url: `${RELEASE_BASE}/kova_0.1.0_universal.dmg`,  label: 'Download for macOS'   },
  win:   { url: `${RELEASE_BASE}/kova_0.1.0_x64_en-US.msi`,  label: 'Download for Windows' },
  linux: { url: `${RELEASE_BASE}/kova_0.1.0_amd64.AppImage`, label: 'Download for Linux'   },
};
